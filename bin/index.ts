...
async function startUpload(endpoint: string, accessToken: string, asset: any, deviceId: string) {
  try {
...
async function getAssetInfoFromServer(endpoint: string, accessToken: string, deviceId: string) {
  try {
